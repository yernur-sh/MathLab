...
import { ArrowRight, BookOpen, Calculator, CheckCircle2, CircleDot, FlaskConical, Lightbulb, Sparkles, Target, Trophy } from "lucide-react";
    ...
    <div className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 pb-16 pt-16 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:pb-24 lg:pt-24">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white/80 px-4 py-2 text-xs font-bold text-indigo-700 shadow-sm">
              ...
              Мектеп математикасына арналған ғылыми жоба
            </div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">MathLab KZ — теорияны оқу, есеп шығару, тест тапсыру және математикалық формулаларды интерактивті зерттеу үшін жасалған шағын оқу платформасы.</p>
            ...
            <div className="mt-8 flex flex-wrap gap-6 text-sm text-slate-500">
              ...
              <span className="inline-flex items-center gap-2"><CheckCircle2 size={17} className="text-emerald-500" /> Firebase профиль</span>
            </div>
          </div>
            ...
            <div className="glass relative mx-auto max-w-xl rounded-[2rem] p-5 sm:p-7">
              <div className="dot-grid rounded-[1.5rem] bg-[#f8fbff] p-6 sm:p-8">
                <div className="flex items-center justify-between">
                  <div><div className="text-xs font-bold uppercase tracking-[0.18em] text-indigo-500">Math canvas</div><div className="mt-1 text-xl font-black text-slate-900">Формула картасы</div></div>
      ...
      <section className="relative mx-auto max-w-7xl px-5 py-20">
        <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
          ...
          <p className="max-w-2xl text-base leading-7 text-slate-600 lg:justify-self-end">Ғылыми жоба идеясы — тек ақпарат көрсету емес, оқушының түсіну → қолдану → тексеру қадамын бір ортада орындауына жағдай жасау.</p>
        </div>
      ...
      <section className="relative mx-auto max-w-7xl px-5 pb-20">
        <div className="overflow-hidden rounded-[2rem] bg-slate-900 px-6 py-10 text-white sm:px-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_.8fr] lg:items-center">
            <div><div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-indigo-300"><Target size={15} /> Жоба мақсаты</div><h2 className="mt-4 text-3xl font-black sm:text-4xl">Оқушыны дайын жауаптан емес, математикалық ойлау процесінен қызықтыру.</h2><p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300">Тақырыпты түсіндіріп, оны шағын тәжірибемен тексеріп, соңында өзін бағалау — платформаның негізгі оқу сценарийі.</p></div>
            <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              {["Түсіну", "Қолдану", "Рефлексия"].map((label, i) => <div key={label} className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3"><div className="grid h-9 w-9 place-items-center rounded-xl bg-white/10 font-black">{i + 1}</div><span className="font-bold">{label}</span><CircleDot size={15} className="ml-auto text-indigo-300" /></div>)}
            </div>
          </div>
        </div>
      </section>
